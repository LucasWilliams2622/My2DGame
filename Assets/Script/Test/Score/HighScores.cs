...
{
    const string privateCode = "ltR_inMAzUebewboUZkMYw_n8I35xEC0C3QBRIuqZneQ";  //Key to Upload New Info
    const string publicCode = "6428f2728f40bb109c01ae3b";   //Key to download
